...
//                 <span className="text-xl font-bold text-white">RAMAERA</span>
//               </Link>
//               <button
...
//                   <span className="font-medium">Switch to Admin Panel</span>
//                 </Link>
//               )}
//             </nav>
...
//               <div className="flex items-center space-x-2 px-4 py-2 bg-green-500/10 rounded-lg border border-green-500/30">
//                 <div className="w-2 h-2 rounded-full bg-green-500"></div>
//                 <span className="text-sm font-semibold text-green-400">USER MODE</span>
//               </div>
//             </div>
//           </header>
...
export function DashboardLayout() {
  ...
  return (
    // Content padding on large screens to account for fixed sidebar width
    <div className="min-h-screen bg-slate-950 lg:pl-64">
      ...
      <aside
        className={[
          ...
          sidebarOpen ? 'translate-x-0' : '-translate-x-full',
          // styling
          'bg-slate-900 border-r border-cyan-500/20',
          // large screens: fixed, visible, full height, no scroll inside
          'lg:translate-x-0 lg:fixed lg:inset-y-0 lg:left-0 lg:w-64 lg:h-screen lg:overflow-hidden'
        ].join(' ')}
      >
        <div className="flex flex-col h-full">
          <div className="flex items-center justify-between h-16 px-6 border-b border-cyan-500/20">
          ...
          {/* No overflow-y-auto so the aside stays non-scrollable */}
